...
trial <- function(mu1, mu2){
# Function to generate t-distribution data
generate_t_distribution <- function(n, avg, d) {
...
sample_size <- 200
replications <- 200
dimensions <- c(205, 405, 603, 803, 1003, 1203, 1401, 1503)
...
for (d in dimensions) {
  ...
  for (i in 1:replications) {
    # Generate data
    data1 <- generate_t_distribution(sample_size, avg = mu1, d)
    data2 <- generate_t_distribution(sample_size, avg = mu2, d)
